...
public class TableSorter extends AbstractTableModel{ //DatumTableModel {
    ...
    private void clearSortingState() {
        viewToModel = null;
        modelToView = null;
        viewToModel = getViewToModel();
        modelToView = getModelToView();
    }
    ...
    private Row[] getViewToModel() {
        //if (viewToModel == null) {
            ...
            viewToModel = new Row[tableModelRowCount+1];
            for (int row = 0; row < tableModelRowCount; row++) {
                viewToModel[row] = new Row(row);
            }
            viewToModel[tableModelRowCount] = new Row(tableModelRowCount);

            if (isSorting()) {
                viewToModel2 = new Row[tableModelRowCount];
                for (int row = 0; row < tableModelRowCount; row++) {
                    viewToModel2[row] = viewToModel[row];
                }
            	            	
                Arrays.sort(viewToModel2);
                
                for (int row = 0; row < tableModelRowCount; row++) {
                    viewToModel[row] = viewToModel2[row];
                }
            }
        //}
        return viewToModel;
