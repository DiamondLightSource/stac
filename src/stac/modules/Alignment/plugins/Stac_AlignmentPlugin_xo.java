...
public class Stac_AlignmentPlugin_xo extends Stac_AlignmentPlugin_gonset implements Stac_AlignmentPlugin {
	/*
	 * 
	 */
	
    public Stac_AlignmentPlugin_xo () {
    ...
    void AddSolutions(String workDir,String in,String out,Util utils) {
	  ...
	  void CallExternalXO(Stac_Session session,int msgId,String indir,String outdir,String command,Util utils) {
		...
		public String getCreditString() {
			return "using XO from Pierre LeGrand";
		}
