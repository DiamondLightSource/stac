...
//===================================================================			
	public void command_factory()
	{
		...
		command_list.addElement(new TranslationCorrectionString("TranslationCorrectionString",
				...
				"",
				DispLevel.OPERATOR));
		command_list.addElement(new AvoidShadow("AvoidShadow",
				Tango_DEV_STRING, Tango_DEV_STRING,
				"NewOscillations",
				"",
				DispLevel.OPERATOR));
 ...
 *
 */
class AvoidShadow extends Command implements TangoConst
{
	//===============================================================
	/**
	 *	Constructor for Command class TranslationCorrectionExt
	 ...
	 */
	//===============================================================
	public AvoidShadow(String name,int in,int out)
	{
		super(name, in, out);
	}
	 ...
	 */
	//===============================================================
	public AvoidShadow(String name,int in,int out, String in_comments, String out_comments)
	{
		super(name, in, out, in_comments, out_comments);
	}
	//===============================================================
	 ...
	 */
	//===============================================================
	public AvoidShadow(String name,int in,int out, String in_comments, String out_comments, DispLevel level)
	{
		super(name, in, out, in_comments, out_comments, level);
	}
	//===============================================================
	...
	{
		((my_tango_server)(device)).addReq();
		Util.out2.println("AvoidShadow.execute(): arrived");
		String arginorig=extract_DevString(in_any);
		String res=((my_tango_server)(device)).AvoidShadow(arginorig);
		((my_tango_server)(device)).delReq();
		return insert(res);
	}
