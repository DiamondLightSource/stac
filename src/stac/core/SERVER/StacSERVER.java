...
public class StacSERVER extends Stac_PluginSlot {
	...
	/**
	 * AvoidShadow: 
	 * receives a data collection sweep and splits into subsweeps to avoid shadow
	 * @param datum osc_start osc_end omegaosc
	 * @return the new osc_start-osc_end pairs
	 */
	public Vector AvoidShadow(Point3d dat,double start, double end,boolean omegaosc) {
		Stac_Out.println("Shadow Avoidance Calculation Request Received");
		return bcm.avoidShadow(dat, start, end, omegaosc);
	}
